...
public class StaxUtilities {
	...
	/**
	 * Shortcut for readSimpleTextNodeIfAvailable(reader, namespaceURI,
	 * nodeName, WhiteSpaceHandling.PRESERVE_NORMALIZE_NEWLINE).
	 * 
	 * @param reader
	 * @param namespaceURI
	 * @param nodeName
	 ...
	 */
	public static String readSimpleTextNodeIfAvailable(XMLStreamReader reader,
			String namespaceURI, String nodeName) throws XMLStreamException {
		return readSimpleTextNodeIfAvailable(reader, namespaceURI, nodeName,
				WhiteSpaceHandling.PRESERVE_NORMALIZE_NEWLINE);
	}

	public static String readSimpleTextNodeIfAvailable(XMLStreamReader reader,
			String namespaceURI, String nodeName, WhiteSpaceHandling whiteSpace)
			throws XMLStreamException {
		...
		if (XMLStreamConstants.START_ELEMENT == type
			...
			if ((namespaceURI == null && reader.getNamespaceURI() == null)
					|| (namespaceURI != null && namespaceURI.equals(reader
							.getNamespaceURI()))) {
	...
	public static String readText(XMLStreamReader reader,
			WhiteSpaceHandling whiteSpace) throws XMLStreamException {
	...
	/**
	 * Shortcut for readAttributeValue(reader, namespaceURI, name,
	 * WhiteSpaceHandling.COLLAPSE);
	 */
	public static String readAttributeValue(XMLStreamReader reader,
			String namespaceURI, String name) {
		return readAttributeValue(reader, namespaceURI, name,
				WhiteSpaceHandling.COLLAPSE);
	}

	public static String readAttributeValue(XMLStreamReader reader,
			String namespaceURI, String name, WhiteSpaceHandling whiteSpace) {
	...
	public static void writeNamespace(XMLStreamWriter writer, String prefix,
	...
	public static NamespaceInfo setNamespace(XMLStreamWriter writer,
			String prefix, String namespaceURI, String defaultPrefix)
			throws XMLStreamException {
		...
		if (p == null) {
			...
			if (prefix == null || NO_PREFIX.equals(prefix)) {
				...
				if (defaultNamespaceURI == null
						|| XMLConstants.NULL_NS_URI.equals(defaultNamespaceURI)) {
					// no defaultNS yet.
					writer.setDefaultNamespace(namespaceURI);
					return new NamespaceInfo(null, true);
				}
				return resolveNamespacePrefix(writer, nsc, defaultPrefix,
						namespaceURI);
			} else {
	...
	private static NamespaceInfo resolveNamespacePrefix(XMLStreamWriter writer,
			NamespaceContext nsc, String prefix, String namespaceURI)
			throws XMLStreamException {
		int counter = 1;
	 ...
	 * @throws XMLStreamException
	 */
	public static void writeStartElement(XMLStreamWriter writer, String prefix,
			String namespaceURI, String nodeName) throws XMLStreamException {
	...
	public static void writeEmptyElement(XMLStreamWriter writer, String prefix,
			String namespaceURI, String nodeName) throws XMLStreamException {
		if (namespaceURI != null) {
			if (prefix != null && !NO_PREFIX.equals(prefix)) {
	...
	/**
	 * Shortcut for writeAttribute(writer, prefix, namespaceURI, name, value,
	 * WhiteSpaceHandling.COLLAPSE).
	 * 
	 * @param writer
	 * @param prefix
	...
	public static void writeAttribute(XMLStreamWriter writer,
			boolean qualified, String prefix, String namespaceURI, String name,
			String value) throws XMLStreamException {
		writeAttribute(writer, qualified, prefix, namespaceURI, name, value,
				WhiteSpaceHandling.COLLAPSE);
	}

	public static void writeAttribute(XMLStreamWriter writer,
			boolean qualified, String prefix, String namespaceURI, String name,
			String value, WhiteSpaceHandling whiteSpace)
			throws XMLStreamException {
	...
	/**
	 * Shortcut for writeAttributeIfNotNull(writer, prefix, namespaceURI, name,
	 * value, WhiteSpaceHandling.COLLAPSE).
	 * 
	 * @param writer
	 * @param prefix
	 * @param namespaceURI
	...
	public static void writeAttributeIfNotNull(XMLStreamWriter writer,
			boolean qualified, String prefix, String namespaceURI, String name,
			String value) throws XMLStreamException {
		writeAttributeIfNotNull(writer, qualified, prefix, namespaceURI, name,
				value, WhiteSpaceHandling.COLLAPSE);
	}
	...
	public static void writeAttributeIfNotNull(XMLStreamWriter writer,
			...
			throws XMLStreamException {
		if (value != null) {
			writeAttribute(writer, qualified, prefix, namespaceURI, name,
					value, whiteSpace);
		}
	}
	 ...
	 * 
	 * If tryUsingCData is true and the text does not contain the CData end
	 * token, the text will be written using writeCData. Otherwise
	 * writeCharacters is used.
	 * 
	 * @param writer
	 * @param prefix
	 *            the prefix of the node. May be null.
	 * @param namespaceURI
	 *            the namespaceURI of the node. May be null.
	 * @param nodeName
	 *            the nodeName of the node.
	 * @param text
	 *            the text that is written into to node. Must not be null.
	 * @param tryUsingCData
	 *            is trying to is CData instead of encoded characters if
	 *            possible.
	 * @throws XMLStreamException
	 * @see #writeText(javax.xml.stream.XMLStreamWriter, String,
	 *      WhiteSpaceHandling, boolean)
	 */
	public static void writeSimpleTextNode(XMLStreamWriter writer,
			String prefix, String namespaceURI, String nodeName, String text,
			WhiteSpaceHandling whiteSpace, boolean tryUsingCData)
			throws XMLStreamException {
	...
	/**
	 * Shortcut for writeSimpleTextNode(writer, prefix, namespaceURI, nodeName,
	 * text, false).
	 * 
	...
	public static void writeSimpleTextNode(XMLStreamWriter writer,
			String prefix, String namespaceURI, String nodeName, String text,
			WhiteSpaceHandling whiteSpace) throws XMLStreamException {
		writeSimpleTextNode(writer, prefix, namespaceURI, nodeName, text,
				whiteSpace, false);
	}
	 ...
	 * text, false).
	 * 
	 * It won't try to use CDATA and uses
	 * WhiteSpaceHandling.PRESERVE_NORMALIZE_NEWLINE.
	 * 
	 * @param writer
	 * @param prefix
	...
	public static void writeSimpleTextNode(XMLStreamWriter writer,
			...
			throws XMLStreamException {
		writeSimpleTextNode(writer, prefix, namespaceURI, nodeName, text,
				WhiteSpaceHandling.PRESERVE_NORMALIZE_NEWLINE, false);
	}

	/**
	 * Writes a &lt;nodeName&gt; node containing the given text if text is not
	 * null.
	 * 
	 * If tryUsingCData is true and the text does not contain the CData end
	 * token, the text will be written using writeCData. Otherwise
	 ...
	 *            the nodeName of the node.
	 * @param text
	 *            the text that is written into to node. May be null.
	 * @param tryUsingCData
	 *            is trying to is CData instead of encoded characters if
	 *            possible.
	 * @throws XMLStreamException
	 ...
	 *      String, String, String, WhiteSpaceHandling, boolean)
	 */
	public static void writeSimpleTextNodeIfNotNull(XMLStreamWriter writer,
			String prefix, String namespaceURI, String nodeName, String text,
			WhiteSpaceHandling whiteSpace, boolean tryUsingCData)
			throws XMLStreamException {
		if (text != null) {
			writeSimpleTextNode(writer, prefix, namespaceURI, nodeName, text,
					whiteSpace, tryUsingCData);
		}
	}
	 ...
	 * 
	 * CDATA is onlyused if tryUsingCData is true and text does not contain the
	 * CDATA end token.
	 * 
	 * @param writer
	 * @param text
	 *            the text to be written. Must not be null.
	 * @param tryUsingCData
	 * @throws XMLStreamException
	 */
	...
	/**
	 * Shortcut for writeText(writer, text,
	 * WhiteSpaceHandling.PRESERVE_NORMALIZE_NEWLINE, false).
	 * 
	 * @param writer
	 * @param text
	...
	public static void writeText(XMLStreamWriter writer, String text)
			throws XMLStreamException {
		writeText(writer, text, WhiteSpaceHandling.PRESERVE_NORMALIZE_NEWLINE,
				false);
	}
